        ...
        <div class="container position-relative z-2">
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="buts d-flex align-items-center">
                    <button class="btn btn-danger me-2 px-4 py-2 rounded-3 swiper-button-prev-recent"></button>
                    <button class="btn btn-danger px-4 py-2 rounded-3 swiper-button-next-recent"></button>
                </div>
            </div>
            <!-- Swiper -->
