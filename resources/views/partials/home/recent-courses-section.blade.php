...
@if ($recentCoursesSection->count() > 0)
    <section class="courses-section position-relative py-5 bg-white">
        ...
        <div class="container position-relative z-2">
            ...
            <div class="d-flex justify-content-between mb-3">
                <div class="mb-4">
                    <span class="text-warning fw-bold mb-2 d-block fs-11">
                        <i class="fas fa-clock"></i> {{ custom_trans('Just Added', 'front') }}
                    </span>
                    <h2 class="fw-bold mb-3 fs-25">{{ custom_trans('Recent Courses', 'front') }}</h2>
                </div>
                @php
                ...
                <div class="buts d-flex align-items-center">
                    @if ($direction === 'rtl')
                        <button class="btn btn-danger me-2 px-4 py-2 rounded-3 swiper-button-prev swiper-button-prev-recent">
                            <i class="fas fa-arrow-right"></i>
                        </button>
                        <button class="btn btn-danger px-4 py-2 rounded-3 swiper-button-next swiper-button-next-recent">
            ...
            <!-- Swiper -->
            <div class="swiper recentCoursesSwiper">
    ...
    <script>
        // Initialize Recent Courses Swiper
        document.addEventListener('DOMContentLoaded', function() {
            new Swiper('.recentCoursesSwiper', {
                slidesPerView: 1,
                spaceBetween: 30,
                loop: true,
                navigation: {
