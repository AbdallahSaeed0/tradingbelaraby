            ...
            <div class="d-flex justify-content-between mb-3">
                <div class="text-start mb-4">
                    <span class="text-warning fw-bold mb-2 d-block fs-11">
                        <i class="fas fa-box-open"></i> {{ __('Bundle Deals') }}
                    </span>
                    <h2 class="fw-bold mb-3 fs-25">{{ __('Subscription Bundles') }}</h2>
                </div>
                <div class="buts d-flex align-items-center">
                    <button class="btn btn-danger me-2 px-4 py-2 rounded-3 swiper-button-prev-bundles"></button>
                    <button class="btn btn-danger px-4 py-2 rounded-3 swiper-button-next-bundles"></button>
                </div>
            </div>
            <!-- Swiper -->
