            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-8 text-white">
                    <h2 class="fw-bold display-4 mb-3">
                        {{ get_current_language_code() === 'ar' && $ctaVideo->title_ar ? $ctaVideo->title_ar : $ctaVideo->title }}
                    </h2>
                    <p class="lead mb-4">
                        {{ get_current_language_code() === 'ar' && $ctaVideo->description_ar ? $ctaVideo->description_ar : $ctaVideo->description }}
                    </p>
                </div>
