                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                                        id="name_ar" name="name_ar" value="{{ old('name_ar', $bundle->name_ar) }}" dir="rtl">
                                    @error('name_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                        id="description" name="description" rows="4" required>{{ old('description', $bundle->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                        id="description_ar" name="description_ar" rows="4" dir="rtl">{{ old('description_ar', $bundle->description_ar) }}</textarea>
                            ...
                            <div class="row" id="courses-container">
                                @foreach($courses as $course)
                                    <div class="col-md-6 mb-3 course-item" data-course-name="{{ strtolower($course->name) }}">
                                        <div class="card h-100 course-select-card {{ in_array($course->id, old('course_ids', $bundle->courses->pluck('id')->toArray())) ? 'selected' : '' }}" 
                                                ...
                                                <div class="d-flex align-items-start">
                                                    <div class="form-check me-3 mt-1">
                                                        <input class="form-check-input course-checkbox" type="checkbox" 
                                                            ...
                                                            {{ in_array($course->id, old('course_ids', $bundle->courses->pluck('id')->toArray())) ? 'checked' : '' }}>
                                                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="image" class="form-label">{{ $bundle->image ? 'Replace Image' : 'Upload Image' }}</label>
            ...
            if (bundleForm) {
                bundleForm.addEventListener('submit', function(e) {
                    ...
                    if (checkedBoxes.length < 2) {
                        e.preventDefault();
                        alert('Please select at least 2 courses to update the bundle.');
                        return false;
                    }
                });
            }
