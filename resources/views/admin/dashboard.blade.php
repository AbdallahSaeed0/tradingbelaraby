            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="text-muted mb-0">{{ custom_trans('admins') }}</h6>
                            <h4 class="fw-bold mb-0">{{ \App\Models\Admin::count() }}</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="text-muted mb-0">{{ custom_trans('courses') }}</h6>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="text-muted mb-0">{{ custom_trans('blogs') }}</h6>
                            <h4 class="fw-bold mb-0">0</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="text-muted mb-0">{{ custom_trans('users') }}</h6>
