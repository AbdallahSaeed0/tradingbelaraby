...
@section('content')
                                                ...
                                                <div class="material-type-selector">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input material-type" type="radio"
                                                            ...
                                                            id="type_link_{{ $index }}" value="link" checked>
                                                ...
                                                <div class="material-file-input" style="display: none;">
                                                    <div class="file-upload-area" data-index="{{ $index }}">
                                                        ...
                                                        <input type="file" class="form-control"
                                                            name="material_files[]" style="display: none;">
                                                        <button type="button"
                                                            class="btn btn-outline-primary btn-sm">Choose File</button>
                                                    </div>
                                                </div>
    ...
    @push('scripts')
        <script>
            let materialIndex = {{ $liveClass->materials ? count($liveClass->materials) : 1 }};
