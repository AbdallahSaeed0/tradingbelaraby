...
@section('content')
    <div class="container-fluid py-4">
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted">Update coupon information</p>
                    </div>
                    <div>
        ...
        <form id="couponForm" action="{{ route('admin.coupons.update', $coupon) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                        id="code" name="code" value="{{ old('code', $coupon->code) }}" required style="text-transform: uppercase;">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('scope') is-invalid @enderror" 
                                        ...
                                        <option value="all_courses" {{ old('scope', $coupon->scope) == 'all_courses' ? 'selected' : '' }}>All Courses</option>
                                        <option value="specific_course" {{ old('scope', $coupon->scope) == 'specific_course' ? 'selected' : '' }}>Specific Course</option>
                                    </select>
                                    @error('scope')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3" id="course_select_wrapper">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('user_scope') is-invalid @enderror" 
                                        ...
                                        <option value="all_users" {{ old('user_scope', $coupon->user_scope) == 'all_users' ? 'selected' : '' }}>All Users</option>
                                        <option value="specific_user" {{ old('user_scope', $coupon->user_scope) == 'specific_user' ? 'selected' : '' }}>Specific User</option>
                                    </select>
                                    @error('user_scope')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3" id="user_select_wrapper">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('usage_limit') is-invalid @enderror" 
                                    id="usage_limit" name="usage_limit" min="1" value="{{ old('usage_limit', $coupon->usage_limit) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('per_user_limit') is-invalid @enderror" 
                                    id="per_user_limit" name="per_user_limit" min="1" value="{{ old('per_user_limit', $coupon->per_user_limit) }}" required>
