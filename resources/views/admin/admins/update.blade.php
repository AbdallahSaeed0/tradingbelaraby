            ...
            <div class="col-lg-8 admin-form-main">
                <div class="card shadow-sm" id="section-profile">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="fa fa-user-edit me-2"></i>Admin Information</h5>
                    </div>
                    <div class="card-body">
                        <form id="adminForm" action="{{ route('admin.admins.update', $admin) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="name_ar" id="name_ar"
                                                ...
                                                value="{{ old('name_ar', $admin->name_ar) }}" dir="rtl">
                                            @error('name_ar')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <select name="admin_type_id" id="admin_type_id"
                                                ...
                                                @foreach ($adminTypes as $type)
                                                    <option value="{{ $type->id }}"
                                                        {{ old('admin_type_id', $admin->admin_type_id) == $type->id ? 'selected' : '' }}>
                                                        {{ $type->display_name }}
                                                        @if ($type->description)
                                                            - {{ $type->description }}
                                                        @endif
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @if ($admin->avatar)
                                            <div class="text-center mb-3">
                                                ...
                                                <p class="text-muted small mt-2">Current avatar</p>
                                            </div>
                                        @endif
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        @if ($admin->cover)
                                            <div class="text-center mb-3">
                                                <img src="{{ asset('storage/' . $admin->cover) }}" alt="Current Cover"
                                                    class="cover-preview">
                                                <p class="text-muted small mt-2">Current cover</p>
                                            </div>
                                        @endif
                            ...
                            <div class="text-end d-none d-lg-block">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save me-2"></i>Update Admin
                                </button>
                            </div>
                        </form>
                    </div>
