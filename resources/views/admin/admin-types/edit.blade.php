                        ...
                        <form action="{{ route('admin.admin-types.update', $adminType) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        value="{{ old('name', $adminType->name) }}" required>
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="sort_order" id="sort_order"
                                        ...
                                        value="{{ old('sort_order', $adminType->sort_order) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                    rows="3" placeholder="Describe what this admin type can do...">{{ old('description', $adminType->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input type="checkbox" name="is_active" class="form-check-input" id="is_active"
                                        value="1" {{ old('is_active', $adminType->is_active) ? 'checked' : '' }}>
                                            ...
                                            <div class="card-body">
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_admins', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_users', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                            ...
                                            <div class="card-body">
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_courses', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_own_courses', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_categories', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_enrollments', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                            ...
                                            <div class="card-body">
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_quizzes', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_own_quizzes', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_homework', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_own_homework', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_live_classes', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_own_live_classes', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_blogs', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                            ...
                                            <div class="card-body">
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_questions_answers', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_own_questions_answers', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('view_analytics', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('view_own_analytics', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                            ...
                                            <div class="card-body">
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_translations', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('manage_languages', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        ...
                                                        {{ in_array('export_data', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="export_data">Export Data</label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" name="permissions[]" class="form-check-input"
                                                        id="import_data" value="import_data"
                                                        {{ in_array('import_data', old('permissions', $adminType->permissions ?? [])) ? 'checked' : '' }}>
                            ...
                            <div class="text-end">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save me-2"></i>Update Admin Type
                                </button>
                            </div>
                        </form>
                    </div>
