...
@section('content')
    <div class="container-fluid admin-settings-subpage py-3 py-lg-4"
        ...
        @include('admin.settings.partials.subpage-header', [
            'title' => 'About Us',
            'subtitle' => "Manage your website's about us page in both English and Arabic.",
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card admin-settings-form-card">
                    ...
                    <div class="card-body">
                        <form id="aboutUsForm" action="{{ route('admin.settings.about-us.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="tab-pane fade show active" id="content-en" role="tabpanel">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                                    rows="10">{{ old('description', $aboutUs->description) }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="content-ar" role="tabpanel">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('title_ar') is-invalid @enderror"
                                                    ...
                                                    value="{{ old('title_ar', $aboutUs->title_ar) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('description_ar') is-invalid @enderror" id="description_ar" name="description_ar"
                                                    rows="10" dir="rtl">{{ old('description_ar', $aboutUs->description_ar) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group admin-settings-slug-group">
                                            ...
                                            <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                                id="slug" name="slug"
                                                value="{{ old('slug', $aboutUs->slug ?? 'about-us') }}"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between admin-settings-inline-actions">
                                        ...
                                        <div>
                                            @if ($aboutUs->exists && $aboutUs->slug)
                                                <a href="{{ route('about-us', $aboutUs->slug) }}"
