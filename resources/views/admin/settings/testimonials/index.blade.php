    ...
    <script>
        ...
        (function() {
            ...
            $(document).on('click', '.delete-testimonial-btn', function() {
                deleteTestimonialId = $(this).data('id');
                $('#deleteConfirmMessage').text('{{ custom_trans('Are you sure you want to delete this testimonial? This action cannot be undone.', 'admin') }}');
                $('#deleteConfirmModal').modal('show');
            });

            $(document).on('click', '#confirmDeleteBtn', function() {
                if (deleteTestimonialId) {
                    const testimonialId = deleteTestimonialId;
