...
@section('content')
    <div class="container-fluid admin-settings-subpage py-3 py-lg-4"
        ...
        @include('admin.settings.partials.subpage-header', [
            'title' => custom_trans('Features Section Management', 'admin'),
            'subtitle' => custom_trans('Manage the homepage features section with statistics and achievements', 'admin'),
            'activeBreadcrumb' => custom_trans('Features', 'admin'),
            'actions' => '<button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#addFeatureModal"><i class="fas fa-plus me-2"></i>' . custom_trans('Add New Feature', 'admin') . '</button>',
        ])
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center">
                                                {{ custom_trans('No features found', 'admin') }}</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
                ...
                <form id="addFeatureForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="add-content-en" class="language-content active">
                            ...
                            <div class="mb-3">
                                <label for="description" class="form-label">{{ custom_trans('Description', 'admin') }}
                                    *</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="number" class="form-label">{{ custom_trans('Number', 'admin') }}
                                        *</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="icon" class="form-label">{{ custom_trans('Icon', 'admin') }}
                                        *</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit"
                            class="btn btn-warning">{{ custom_trans('Create Feature', 'admin') }}</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form id="editFeatureForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="edit_number" class="form-label">{{ custom_trans('Number', 'admin') }}
                                        *</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">{{ custom_trans('Cancel', 'admin') }}</button>
                        <button type="submit"
                            class="btn btn-warning">{{ custom_trans('Update Feature', 'admin') }}</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="viewFeatureModal" tabindex="-1" aria-labelledby="viewFeatureModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewFeatureModalLabel">{{ custom_trans('Feature Details', 'admin') }}
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
        ...
        $(document).ready(function() {
            ...
            $('.delete-feature').on('click', function() {
                ...
                $('#deleteConfirmMessage').text(
                    '{{ custom_trans('Are you sure you want to delete this feature? This action cannot be undone.', 'admin') }}'
                    );
                $('#deleteConfirmModal').modal('show');
            });
