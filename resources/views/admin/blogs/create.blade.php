...
@section('content')
    <div class="container-fluid py-4 admin-form-page" data-mobile-back-url="{{ route('admin.blogs.index') }}" data-mobile-back-label="Back to Blogs">
        @include('admin.partials.crud-form-shell', [
            ...
            'subtitle' => 'Add a new blog post to your website',
                            ...
                            <div id="content-ar" class="language-content">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="slug_ar" value="{{ old('slug_ar') }}" placeholder="رابط-مخصص">
                                            @error('slug_ar')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('excerpt_ar') is-invalid @enderror" id="excerpt_ar" name="excerpt_ar"
                                        rows="3" placeholder="أدخل ملخص قصير للمدونة">{{ old('excerpt_ar') }}</textarea>
                                    @error('excerpt_ar')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" id="description_ar"
                                        name="description_ar" placeholder="أدخل محتوى المدونة">{{ old('description_ar') }}</textarea>
                        ...
                        <div id="seo-en" class="language-content active">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
                                    name="meta_description" rows="3" maxlength="160" placeholder="SEO description for search engines">{{ old('meta_description') }}</textarea>
                        ...
                        <div id="seo-ar" class="language-content">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('meta_title_ar') is-invalid @enderror"
                                    id="meta_title_ar" name="meta_title_ar" value="{{ old('meta_title_ar') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description_ar') is-invalid @enderror" id="meta_description_ar"
                                    name="meta_description_ar" rows="3" maxlength="160" placeholder="وصف SEO لمحركات البحث">{{ old('meta_description_ar') }}</textarea>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="post_to_telegram" name="post_to_telegram"
                                    value="1" {{ old('post_to_telegram') ? 'checked' : '' }}>
                            ...
                            <div class="ps-4 mb-2">
                                <div class="form-check mb-2">
                                    <input class="form-check-input telegram-lang-option" type="checkbox" id="telegram_send_ar"
                                        name="telegram_send_ar" value="1" {{ old('telegram_send_ar') ? 'checked' : '' }}>
                                ...
                                <div class="form-check mb-0">
                                    <input class="form-check-input telegram-lang-option" type="checkbox" id="telegram_send_en"
                                        name="telegram_send_en" value="1" {{ old('telegram_send_en') ? 'checked' : '' }}>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setupImagePreview('image_ar', 'image-ar-preview');

            // Check if there's a success message and reset form if needed
            const successMessage = document.querySelector('.alert-success');
            if (successMessage && successMessage.textContent.includes('created successfully')) {
                // Form was submitted successfully, reset it
                ...
                if (window.ClassicEditor && window.ClassicEditor.instances) {
                    Object.values(window.ClassicEditor.instances).forEach(editor => {
                        if (editor.element.id === 'description' || editor.element.id === 'description_ar') {
                            editor.setData('');
                        }
                    });
                }
