...
@push('styles')
    <style>
        /* Aggressive pagination styling - target everything */
        .pagination,
        ...
        .container-fluid .pagination .page-link:hover {
            background-color: #e9ecef !important;
            border-color: #dee2e6 !important;
            color: #495057 !important;
        }

        .container-fluid .pagination .page-item.active .page-link {
            background-color: #0d6efd !important;
            border-color: #0d6efd !important;
            color: #fff !important;
        }

        .container-fluid .pagination .page-item.disabled .page-link {
            color: #6c757d !important;
            background-color: #fff !important;
            border-color: #dee2e6 !important;
        }

        /* Make pagination arrows smaller with higher specificity */
        .pagination svg,
        .pagination .page-link svg,
        .container-fluid .pagination svg,
        .container-fluid .pagination .page-link svg,
        nav[aria-label="Pagination Navigation"] svg,
        nav[aria-label="Pagination Navigation"] .page-link svg,
        nav[aria-label="Pagination Navigation"] a svg,
        nav[aria-label="Pagination Navigation"] span svg,
        .container-fluid .pagination .page-link i,
        .container-fluid .pagination .page-link .fa,
        .container-fluid .pagination .page-link .fas {
        ...
        /* Target Laravel's default pagination icons */
        .pagination .page-link[aria-label*="Next"] svg,
        .pagination .page-link[aria-label*="Previous"] svg,
        .pagination .page-link[aria-label*="&raquo;"] svg,
        .pagination .page-link[aria-label*="&laquo;"] svg,
        .container-fluid .pagination .page-link[aria-label*="Next"] svg,
        .container-fluid .pagination .page-link[aria-label*="Previous"] svg,
        .container-fluid .pagination .page-link[aria-label*="&raquo;"] svg,
        .container-fluid .pagination .page-link[aria-label*="&laquo;"] svg,
        nav[aria-label="Pagination Navigation"] a[aria-label*="Next"] svg,
        nav[aria-label="Pagination Navigation"] a[aria-label*="Previous"] svg,
        nav[aria-label="Pagination Navigation"] a[aria-label*="&raquo;"] svg,
        nav[aria-label="Pagination Navigation"] a[aria-label*="&laquo;"] svg {
            width: 14px !important;
            height: 14px !important;
            max-width: 14px !important;
            max-height: 14px !important;
        ...
        /* Target any SVG in pagination links */
        .pagination svg,
        .container-fluid .pagination svg,
        nav[aria-label="Pagination Navigation"] svg {
            width: 14px !important;
