...
@section('content')
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">Edit Language</h1>
                        ...
                        <form action="{{ route('admin.languages.update', $language) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="native_name" value="{{ old('native_name', $language->native_name) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('direction') is-invalid @enderror" id="direction"
                                            ...
                                            <option value="ltr"
                                                {{ old('direction', $language->direction) == 'ltr' ? 'selected' : '' }}>Left
                                                to Right (LTR)</option>
                                            <option value="rtl"
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save me-2"></i>Update Language
                                </button>
                            </div>
                        </form>
                    </div>
