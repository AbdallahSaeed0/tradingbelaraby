...
// Google Play RTDN Webhook (public endpoint - must be excluded from CSRF)
Route::post('/webhook/google-play', [App\Http\Controllers\GooglePlayWebhookController::class, 'handle'])->name('webhook.google-play');
...
Route::resource('quizzes.questions', App\Http\Controllers\Admin\QuizQuestionManagementController::class)->middleware('admin.permission:manage_quizzes,manage_own_quizzes');
    ...
    // Blogs analytics route must be before resource route to avoid route conflict
