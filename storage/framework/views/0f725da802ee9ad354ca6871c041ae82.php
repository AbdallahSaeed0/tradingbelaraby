...
<?php if($aboutUniversity): ?>
    <section class="about-uni-section position-relative py-5 bg-light-f3">
        <div class="container position-relative z-2">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4 mb-lg-0 d-flex justify-content-center">
                    <img src="<?php echo e($aboutUniversity->image_url); ?>"
                        alt="<?php echo e(get_current_language_code() === 'ar' && $aboutUniversity->title_ar ? $aboutUniversity->title_ar : $aboutUniversity->title); ?>"
                        class="img-fluid">
                </div>
                <!-- Text and Features -->
                <div class="col-lg-6">
                    <span class="text-warning fw-bold mb-2 d-block fs-11">
                        <i class="fas fa-graduation-cap"></i> <?php echo e(__('About Our University')); ?>

                    </span>
                    <h2 class="fw-bold mb-3 fs-25">
                        <?php echo e(get_current_language_code() === 'ar' && $aboutUniversity->title_ar ? $aboutUniversity->title_ar : $aboutUniversity->title); ?>

                    </h2>
                    <p class="mb-4 text-blue-247">
                        <?php echo e(get_current_language_code() === 'ar' && $aboutUniversity->description_ar ? $aboutUniversity->description_ar : $aboutUniversity->description); ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-start">
                                    <span class="about-number me-3"><?php echo e($feature->number); ?></span>
                                    <div>
                                        <div class="fw-bold">
        ...
        <?php if($aboutUniversity->background_image): ?>
            <img src="<?php echo e($aboutUniversity->background_image_url); ?>" alt="contact-bg-an-01"
                class="about-bg-img d-none d-md-block">
        <?php endif; ?>
    </section>
<?php endif; ?>
<?php /**PATH C:\laragon\www\courses-laravel\resources\views/partials/home/about-university.blade.php ENDPATH**/ ?>