...
<section class="hero hero-colored">
        ...
        <div class="swiper-wrapper">
            <?php $__empty_1 = true; $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="swiper-slide hero-slide"
                    style="background-image: url('<?php echo e($slider->background_image_url); ?>');">
                    ...
                    <div class="row align-items-center min-vh-75 min-h-520">
                        <div class="col-lg-12 container col-md-10 mx-auto text-center text-lg-start">
                            <span
                                class="hero-welcome d-block mb-2"><?php echo e(get_current_language_code() === 'ar' && $slider->welcome_text_ar ? $slider->welcome_text_ar : $slider->welcome_text); ?>

                                <span class="hero-underline"></span></span>
                            <h1 class="fw-bold mb-3">
                                <?php echo e(get_current_language_code() === 'ar' && $slider->title_ar ? $slider->title_ar : $slider->title); ?>

                            </h1>
                            <p class="hero-sub mb-4">
                                <?php echo e(get_current_language_code() === 'ar' && $slider->subtitle_ar ? $slider->subtitle_ar : $slider->subtitle); ?>
                            ...
                            <form class="search-box search-box-colored d-flex mx-auto mx-lg-0 max-w-480">
                                <input type="text" class="form-control rounded-start-pill"
                                    placeholder="<?php echo e(get_current_language_code() === 'ar' && $slider->search_placeholder_ar ? $slider->search_placeholder_ar : $slider->search_placeholder); ?>">
                                <button type="submit"
                                    class="btn btn-primary rounded-end-pill px-4 btn-orange"><?php echo e(get_current_language_code() === 'ar' && $slider->button_text_ar ? $slider->button_text_ar : $slider->button_text); ?></button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="row hero-features text-center mt-5 d-none d-md-flex">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $heroFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heroFeature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-md-<?php echo e(12 / min(count($heroFeatures), 3)); ?> mb-3 mb-md-0">
                <div class="hero-feature-box d-flex align-items-center h-100">
                    <i class="<?php echo e($heroFeature->icon); ?> fa-3x me-4"></i>
                    <div class="text-start">
                        <div class="hero-feature-title fw-bold mb-1">
                            <?php echo e(get_current_language_code() === 'ar' && $heroFeature->title_ar ? $heroFeature->title_ar : $heroFeature->title); ?>

                        </div>
                        <div class="hero-feature-subtitle">
                            <?php echo e(get_current_language_code() === 'ar' && $heroFeature->subtitle_ar ? $heroFeature->subtitle_ar : $heroFeature->subtitle); ?>
...
<section class="mobile-hero-features d-block d-md-none py-4">
    <div class="container">
        <div class="row">
            ...
            ?>
            <?php $__empty_1 = true; $__currentLoopData = $heroFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heroFeature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-12 <?php echo e($loop->last ? '' : 'mb-3'); ?>">
...
<?php /**PATH C:\laragon\www\courses-laravel\resources\views/partials/home/hero.blade.php ENDPATH**/ ?>