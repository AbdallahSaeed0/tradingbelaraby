...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-lg-10">
                    <div class="text-center text-white mb-5">
                        <div class="course-badge mb-3">
                            <i class="fas fa-graduation-cap me-2"></i><?php echo e($course->name); ?>

                        </div>
                        <h1 class="display-4 fw-bold mb-3"><?php echo e($quiz->title); ?></h1>
                        <p class="lead mb-4 opacity-90"><?php echo e($quiz->description); ?></p>
                            ...
                            <div class="row g-3 justify-content-center">
                                <div class="col-auto">
                                    <div class="stat-pill">
                                        ...
                                        <?php echo e($quiz->questions->count()); ?> Questions
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <div class="stat-pill">
                                        <i class="fas fa-clock"></i>
                                        <?php echo e($quiz->time_limit_minutes ? $quiz->time_limit_minutes . ' min' : 'No limit'); ?>
                                ...
                                <div class="col-auto">
                                    <div class="stat-pill">
                                        ...
                                        <?php echo e($quiz->max_attempts ? $quiz->max_attempts . ' attempts' : 'Unlimited'); ?>
                                ...
                                <div class="col-auto">
                                    <div class="stat-pill">
                                        ...
                                        <?php echo e($quiz->passing_score); ?>% to pass
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="instructions-body">
                                ...
                                <?php if($quiz->time_limit_minutes): ?>
                                    <div class="instruction-item">
                                        ...
                                        <span>You have <?php echo e($quiz->time_limit_minutes); ?> minutes to complete this quiz</span>
                                    </div>
                                <?php endif; ?>
                                <?php if($quiz->max_attempts): ?>
                                    <div class="instruction-item">
                                        ...
                                        <span>You can attempt this quiz up to <?php echo e($quiz->max_attempts); ?> times</span>
                                    </div>
                                <?php endif; ?>
                                <div class="instruction-item">
                                    <div class="instruction-icon">
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $attempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <div class="fw-semibold"><?php echo e($attempt->created_at->format('M d, Y')); ?>

                                                    </div>
                                                    <small
                                                        class="text-muted"><?php echo e($attempt->created_at->format('g:i A')); ?></small>
                                                </td>
                                                <td>
                                                    <?php if($attempt->percentage_score !== null): ?>
                                                        <span
                                                            class="score-badge <?php echo e($attempt->percentage_score >= 80 ? 'score-excellent' : ($attempt->percentage_score >= 60 ? 'score-good' : 'score-poor')); ?>">
                                                            <?php echo e(number_format($attempt->percentage_score, 1)); ?>%
                                                        </span>
                                                    <?php else: ?>
                                                ...
                                                <td>
                                                    <span
                                                        class="status-badge <?php echo e($attempt->status == 'completed' ? 'status-completed' : 'status-in-progress'); ?>">
                                                ...
                                                <td>
                                                    <?php if($attempt->status == 'completed'): ?>
                                                        <a href="<?php echo e(route('quizzes.results', ['quiz' => $quiz, 'attempt' => $attempt])); ?>"
                            ...
                            <div class="position-relative">
                                ...
                                <div class="warning-alert">
                                    ...
                                    <ul>
                                        ...
                                        <?php endif; ?>
                                        <?php if($quiz->required_lectures): ?>
                                            <li>You need to complete <?php echo e($quiz->required_lectures); ?> lectures first</li>
                                        <?php endif; ?>
                                        <?php if($quiz->max_attempts && $attempts->count() >= $quiz->max_attempts): ?>
                                            <li>You have reached the maximum number of attempts</li>
                                        <?php endif; ?>
                                        <?php if($attempts->where('status', 'in_progress')->count() > 0): ?>
                                            <li>You have an ongoing attempt. Please complete it first.</li>
                                        <?php endif; ?>
                                    </ul>
                                </div>
                                <a href="<?php echo e(route('courses.learn', $course->id)); ?>" class="back-btn">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body p-4">
                    <p class="mb-3">Are you sure you want to start the quiz <strong>"<?php echo e($quiz->title); ?>"</strong>?</p>
    ...
    <script>
        ...
        function confirmStartQuiz() {
            ...
            fetch('<?php echo e(route('quizzes.start', $quiz)); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\courses-laravel\resources\views/quizzes/show.blade.php ENDPATH**/ ?>